...
At the very top of the packaging, a bold red header band displays the text: '[Name] the [Title]' in large, clear, white letters.
Full product shot of a highly detailed action figure, fully encased in a clear plastic blister pack with a colorful cardboard backing. The packaging, accessories, and compartments are the main focus. The action figure is shown in full body, including legs, standing upright inside the blister pack. Inside the blister pack are compartments for each coding language and its animal ([key items]), as well as coding-related accessories such as a keyboard, laptop, or code book. Each item is in its own separate compartment. The figure's facial features are subtly inspired by: [person_features]. The packaging is centered on a white background, with an 'Ages [X]+' label. Professional retail packaging with detailed labeling and product information. Sharp focus on packaging details. No cropping of the blister pack.
`;
